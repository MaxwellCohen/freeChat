    ...
    <div className="flex-1 flex items-center justify-center px-4">
      <div className="text-center max-w-3xl mx-auto w-full">
        <h1 className="text-6xl font-bold mb-4 bg-gradient-to-r from-orange-500 to-red-600 text-transparent bg-clip-text uppercase">
          <span className="text-white">FreeChat</span>
        </h1>
        <p className="text-gray-400 mb-6 w-2/3 mx-auto text-lg">
          You can ask me about anything, I might or might not have a good
          answer, but you can still ask. Because I'm a free chatbot, I don't
          use paid LLMs.
        </p>
        {children}
      </div>
...
export const Route = createFileRoute('/freechat')({
  component: ChatPage,
})
